...
instance Eq Country where
  a == b = if a == Finland && b == Finland then True else if a == Switzerland && b == Switzerland then True else if a == Norway && b == Norway then True else False
...
instance Num RationalNumber where
  (RationalNumber a b) + (RationalNumber c d) = let g = gcd (a * d + c * b) (b * d)
                                                in RationalNumber ((a * d + c * b) `div` g) ((b * d) `div` g)
  (RationalNumber a b) * (RationalNumber c d) = let g = gcd (a * c) (b * d)
                                                in RationalNumber ((a * c) `div` g) ((b * d) `div` g)
