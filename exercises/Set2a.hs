...
takeFinal :: Int -> [a] -> [a]
takeFinal n list = if length list < n then list else drop (length list - n) list
...
addEithers a b = if Left a then a else if Right a && Right b then Right (Right a + Right b) else b
